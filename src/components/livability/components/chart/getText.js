const getFitText = (category, city) => {
  if (category === 'income') {
    return city + "'s wealth is nothing special. It's not a rich city like San Jose, but it's not poor like Detroit"
  } else if (category === 'ufo') {
    return "Aliens don't love " + city + ' like they love New York, but they like ' + city + ' more than Oakland'
  } else if (category === 'temperature') {
    return 'Normal temperatures in ' + city + '. Not hot like Houston nor cold like Milwaukee'
  } else if (category === 'crime') {
    return city + ' is more dangerous than Arlington, but safer than Oakland'
  } else if (category === 'population') {
    return city + " isn't a rat next like New York, and isn't a yuppie village like Arlington"
  } else if (category === 'air') {
    return 'Fresno has worse air than ' + city + ' ,but Colorado Springs has better'
  } else if (category === 'parking') {
    return 'You can find quicker parking in Omaha, but ' + city + ' is still quicker than New York'
  } else if (category === 'size') {
    return city + ' is bigger than Miami, but smaller than Jacksonville'
  } else {
    return city + " doesn't have as many electric car stations as Los Angeles, but has more than Wichita"
  }
}
...
const getNoFitText = (category, city, direction) => {
  if (direction === 1) {
    if (category === 'income') {
      ...
      return 'The school district of ' + city + ' needs to introduce a class on sex education'
    } else if (category === 'air') {
      ...
      return city + ' has lots of extra land for big American dreams'
    } else {
    ...
    if (category === 'income') {
      ...
      return 'The mayor of ' + city + ' should consider programs to encourage more romance'
    } else if (category === 'air') {
      ...
      return city + " doesn't support electric cars. Not many places to charge them"
    }
  }
}
