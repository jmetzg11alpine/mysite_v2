...
const Header = ({ section, setSection }) => {
  ...
  return (
    <div className='d3-header-container'>
      ...
      <button onClick={handleClick} value='spending'>
        Spending
      </button>
      <button onClick={handleClick} value='airport'>
        Airport
      </button>
      <button onClick={handleClick} value='r_and_d'>
        R&D
      </button>
      <button onClick={handleClick} value='ranking'>
        Ranking
      </button>
    </div>
  )
